...
Consider the original [M-LWE](/lwe/#module-lwe) construction for a random matrix $$\mat{A} \leftarrow \mathcal{U}(\mathcal{R}_q^{m\times n})$$ and secrets $$\begin{bmatrix}\mat{S} \\ \mat{E}\end{bmatrix} \leftarrow \chi^m$$. Let $$\mat{R} = \begin{bmatrix}\mat{E} & \mat{I}_m \\ \mat{0} & \mat{S} \\ \mat{0} & \mat{I}_m\end{bmatrix}.$$
...
Hint-MLWE$$^{\ell,(\mathcal{D}_{\mathbf{c}_i,\mathbf{\Sigma}_i})_{i \in [\ell]}, \mathcal{\mathcal{H}}}_{n,m,q,\mathcal{D}_{\mathbf{c},\mathbf{\Sigma}},\mathcal{R}}$$ is at least as hard as [short secret M-LWE](/lwe/#module-lwe)$$_{n,m,q,\mathcal{D}_\sigma,\mathcal{R}}$$. The private variables follow (elliptical) Gaussian distributions because the proof is highly due to convolution of discrete Gaussian distribution. 
