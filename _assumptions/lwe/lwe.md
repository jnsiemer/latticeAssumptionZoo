...
Note that the history of definitions of Ring-LWE is a bit chaotic as the given definition was preceeded by Polynomial Ring-LWE (also referred to as Ideal-LWE) {% cite AC:SSTX09 %}, which requires $$f$$ to be a monic and irreducible. Similar to this deviation, some versions were referred to as Dual- and Primal-LWE. The papers {% cite EC:RosSteWal18 %} and {% cite JC:PeiPep24 %} provide a structured overview and reductions.
