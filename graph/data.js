...
assumption('H-SIS', 'H-SIS', 2026, ['Sign'], '/h-sis/', 'SIS');
assumption('H-ISIS', 'H-ISIS', 2026, ['Sign'], '/h-sis/#h-isis', 'SIS', true);
assumptionFamily('H-SIS', ['H-SIS', 'H-ISIS']);
...
partiallyReducesTo('SIS', 'H-SIS', 'Assuming the space-time hardness of SIS');
